...
<div x-data="{ label: 'Click Here' }">
    <button  x-text="label"></button>
    <p x-html="  <strong> <i> Hello</i></strong>"> wolrd</p>
</div>

<hr>
<!-- x-data with method  -->

<div x-data="{ msg:'click me to change ' ,change(){ this.msg=' i am changed'}}">
<span x-text='msg' @click="change()"></span>
</div>

<hr>
<!-- re usable data and x-show -->
<div x-data="dropdown">
...
<div x-data x-text="$store.currentuser.name">
</div>
...
<div x-init="console.log('init')">
    <div x-data="{
        ()
        {
          init  console.log('init function called')
        }
    }">
    ...
    <div x-data="{ name:'ashutosh',mobile:'9373545745'}">
        <div x-data="{ name:'tejas',age:'18'}">
            <div x-data="{ name:'hrutuja'}">
                <p x-text='name'></p>
                <p x-text='age'></p>
                <p x-text='mobile'></p>
            </div>
    ...
    toggle123()
    {
        ...
        <button @click="toggle123">Dropdown</button>
        <div x-show='open'>
            contet
        </div>
    </div>
    ...
    toggle12()
    {
        ...
        <button @click="toggle12">Dropdown</button>
        <div x-show='open' x-transition:enter.duration.5000ms x-transition:leave.duration.5000ms>
            contet
        </div>
    </div>
    <hr>
    ...
    <div x-data="{ my_posts: [ { id:1 , title:'one' }, { id:2 , title:'two' } ] }">
        <template x-for="post in my_posts" :key='post.id'>
            <h1 x-text="post.id +'  '+ post.title"> </h1>
        </template>
    </div>
    ...
    {{-- <div x-data="{ clicked : false}">
        <button class="text-red-500" x-bind:class="clicked ? 'bg-blue-500':''" @click="clicked=true">Click Me</button>
    </div>
    <hr>
    ...
    <div x-data="{ clicked : false}">
        <button class="text-red-500" :style=" { backgroundColor: clicked ? 'green':'' }" @click="clicked=!clicked">Click
            Me</button>
    </div>
    <hr>
...
yru
    ...
    <div class="flex bg-gray-300 h-screen" x-data="{ isSidebarExpanded: true }">
        ...
        <div class="flex-1 flex flex-col bg-red-500">
