<div>
    ...
    <header class="relative bg-white dark:bg-darker">
        <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
            ...
            <!-- Sidebar button -->
            <button @click="isSidebarExpanded = !isSidebarExpanded" class="p-1 transition-colors duration-200 rounded-md text-primary-lighter bg-primary-50 hover:text-primary hover:bg-primary-100 dark:hover:text-light dark:hover:bg-primary-dark dark:bg-dark  focus:outline-none focus:ring hidden md:block">
            ...
            <!-- Brand -->
            <a href="{{ route('dashboard') }}" class="  md:hidden text-2xl font-bold tracking-wider uppercase text-primary-dark dark:text-light">
                {{ env('APP_NAME') }}
            </a>
